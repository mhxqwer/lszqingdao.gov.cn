    ...
    function shareTo(stype, ele) {
        ...
        if (flag.length > 0) {
            ...
            if (document.getElementsByTagName("img").length) {
                if (document.getElementsByTagName("img")[imgMax].width >= 80 && document.getElementsByTagName("img")[imgMax].height >= 80) {
        ...
        $.ajax({
            url: ajaxUrl + "/common/gather/gatherShare",
            type: "POST",
        ...
        //新浪微博接口的传参
        if (stype == 'sina') {
            if (shareParams.sharePic.indexOf(".png") < 0 && shareParams.sharePic.indexOf(".jpg") < 0 && shareParams.sharePic.indexOf(".jpeg") < 0 && shareParams.sharePic.indexOf(".gif") < 0) {
                shareParams.sharePic = "";
            }
            shareParams.shareUrl = encodeURIComponent(shareParams.shareUrl);
            window.open('http://service.weibo.com/share/share.php?title=' + shareParams.shareTitle + '&sharesource=weibo&url=' + shareParams.shareUrl + '&pic=' + shareParams.sharePic  + '&searchPic=false');
        }
        //qq好友接口的传参
        if (stype == 'qq') {
            shareParams.shareUrl = encodeURIComponent(shareParams.shareUrl);
        ...
        if (stype == 'wechat') {
            ...
            if (!hasqrcode) {
                ...
                $("body").append('<div class="trs_share_box"><div class="share_title">分享到微信朋友圈<a class="share_close">×</a></div><div class="share_qrcode_box"></div></div>');
    ...
    if (getRequest().share == 1) {
        ha_glob_coo_cb = function () {
            ...
            if (setCookie == (globalCookie + "," + time)) {} else {
                ...
                $.ajax({
                    url: ajaxUrl + "/common/gather/gatherShareBack",
                    type: "POST",
                    data: backAjaxParams
                })
